      ...
      <div className="flex-1 p-6 space-y-6 max-w-6xl mx-auto w-full">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">2024년 1학기 · 연세대학교 컴퓨터과학과</p>
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { label: "수강 중인 수업", value: "5", icon: BookOpen, color: "text-blue-600 bg-blue-50" },
            { label: "같은 수업 친구", value: "247명", icon: Users, color: "text-violet-600 bg-violet-50" },
            { label: "이번 주 학습 목표", value: "3/5", icon: CheckCircle2, color: "text-green-600 bg-green-50" },
            { label: "커뮤니티 활동", value: "12", icon: TrendingUp, color: "text-amber-600 bg-amber-50" },
          ].map((stat) => (
          ...
          <Card className="border-0 shadow-sm">
            ...
            <CardContent className="space-y-3">
              {todaySchedule.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground py-4 text-center">오늘 수업이 없어요</p>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="bg-white rounded-lg p-3 shadow-sm">
                ...
                <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                  운영체제 교착상태, 데이터베이스 정규화 복습을 우선 추천드려요.
                </p>
              ...
              <div className="bg-white rounded-lg p-3 shadow-sm">
                <p className="text-sm font-medium">놓치지 말 것</p>
                <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                  알고리즘 과제 제출 마감이 3일 남았어요.
                </p>
              </div>
            </CardContent>
          </Card>
