    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary flex-col justify-between p-12">
        ...
        <div className="text-white">
          <blockquote className="text-2xl font-medium leading-relaxed mb-4">
            &ldquo;같은 강의, 같은 고민을 가진 친구들과 함께라면 대학 생활이 훨씬 풍요로워져요.&rdquo;
          </blockquote>
          <p className="text-primary-foreground/70">— UniLink 사용자, 연세대학교 컴퓨터과학과</p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-2xl font-bold mb-2">다시 만나요</h1>
