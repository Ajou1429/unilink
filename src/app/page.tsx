...
const features = [
  {
    ...
    title: "스마트 시간표",
    description:
      "시간표를 만들고 같은 강의를 듣는 친구들과 자동으로 연결돼요. 학교 공식 수업 데이터와 연동됩니다.",
  ...
  },
  {
    ...
    title: "수업 커뮤니티",
    description:
      "같은 시간표의 사람들과 그룹을 만들어요. 과제, 시험 정보, 노트를 함께 공유하세요.",
  ...
  },
  {
    ...
    title: "익명 게시판",
    description:
      "학교 생활의 모든 것을 익명으로 자유롭게 이야기해요. 고민, 정보 공유, 일상 모두 OK.",
  ...
  },
  {
    ...
    title: "AI 학습 플랜",
    description:
      "AI가 수업별 학습 계획을 추천해드려요. 강의 노트 정리부터 시험 대비까지 맞춤 플랜.",
    color: "bg-amber-50 text-amber-600",
  },
];

const stats = [
  { value: "50+", label: "연동 대학교" },
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 inset-x-0 z-50 border-b bg-white/80 backdrop-blur-md">
        <div className="mx-auto max-w-6xl px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-muted-foreground">
            ...
            <a href="#how" className="hover:text-foreground transition-colors">이용 방법</a>
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-foreground leading-tight mb-6">
            시간표로 시작하는<br />
            <span className="text-primary">대학 생활 커뮤니티</span>
          </h1>
          <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
            같은 강의를 듣는 사람들과 연결되고, 익명으로 자유롭게 소통하고,
            AI가 도와주는 학습 계획으로 성적까지 올리세요.
          </p>
      ...
      <section id="features" className="py-24 px-4 bg-slate-50">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">대학 생활에 필요한 모든 것</h2>
            <p className="text-muted-foreground text-lg">
              하나의 앱으로 수업, 커뮤니티, 학습을 모두 관리하세요.
            </p>
          </div>
      ...
      <section id="how" className="py-24 px-4">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">간단하게 시작할 수 있어요.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { step: "01", title: "학교 이메일로 가입", desc: "재학생 인증으로 신뢰할 수 있는 커뮤니티를 만들어요." },
              { step: "02", title: "시간표 입력", desc: "이번 학기 수업을 입력하면 자동으로 같은 수업 친구들과 연결돼요." },
              { step: "03", title: "함께 공부 시작", desc: "커뮤니티에 참여하고 AI 학습 플랜으로 성적을 올려보세요." },
            ].map((item) => (
      ...
      <section id="pricing" className="py-24 px-4 bg-slate-50">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">학생을 위한 가격으로 시작하세요.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <Card className="border shadow-sm">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold mb-1">무료</h3>
                <div className="text-3xl font-bold mb-4">₩0<span className="text-sm font-normal text-muted-foreground">/월</span></div>
                <ul className="space-y-3 mb-6">
                  {["시간표 생성", "수업 커뮤니티", "익명 게시판", "기본 학습 노트"].map((f) => (
            ...
            <Card className="border-primary shadow-md relative overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <div className="text-3xl font-bold mb-4">₩4,900<span className="text-sm font-normal text-muted-foreground">/월</span></div>
                <ul className="space-y-3 mb-6">
                  {["무료 플랜 모든 기능", "AI 학습 계획 생성", "강의 노트 AI 정리", "시험 대비 맞춤 문제", "광고 없음"].map((f) => (
                    <li key={f} className="flex items-center gap-2 text-sm">
      ...
      <section className="py-24 px-4 bg-primary">
        <div className="mx-auto max-w-3xl text-center text-white">
          ...
          <p className="text-primary-foreground/80 text-lg mb-8">
            10만 명의 대학생이 이미 UniLink와 함께 대학 생활을 즐기고 있어요.
          </p>
          <Link href="/signup">
      ...
      <footer className="py-8 px-4 border-t">
        <div className="mx-auto max-w-6xl flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm text-muted-foreground">© 2024 UniLink. All rights reserved.</p>
